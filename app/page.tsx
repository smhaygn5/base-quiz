...
const CRYPTO_Q = [
  ...
  { q: "Which language is used to write smart contracts on Base?", a: ["Python", "Rust", "Solidity", "Go"], c: 2 },
  ...
  { q: "What is Uniswap primarily?", a: ["Lending platform", "DEX (decentralized exchange)", "Wallet", "Bridge"], c: 1 },
  ...
  { q: "What is Aave primarily?", a: ["DEX", "Lending protocol", "Stablecoin", "NFT marketplace"], c: 1 },
  ...
  { q: "What primarily backs DAI?", a: ["US Dollars in a bank", "Crypto collateral", "Gold reserves", "Government bonds"], c: 1 },
  ...
  { q: "What is OpenSea primarily?", a: ["DEX", "NFT marketplace", "Wallet", "L2 chain"], c: 1 },
  ...
  { q: "What is MetaMask primarily?", a: ["Exchange", "Browser wallet", "Hardware wallet", "L2 chain"], c: 1 },
  ...
  { q: "What is another name for a blockchain transaction hash?", a: ["Nonce", "TX ID", "Block height", "Gas limit"], c: 1 },
  ...
  { q: "What is a 'testnet' used for?", a: ["Real transactions", "Testing without real value", "Storing coins", "Mining Bitcoin"], c: 1 },
  ...
  { q: "What type of blockchain is Solana?", a: ["Layer-2 of Ethereum", "Standalone Layer-1 blockchain", "Wallet", "Stablecoin"], c: 1 },
  ...
  { q: "What is generally true of a wallet address?", a: ["Secret, never shared", "Public and shareable to receive funds", "Your password", "A private key"], c: 1 },
  ...
  { q: "What is the 'genesis block'?", a: ["Last block", "First block of a blockchain", "A wallet", "A token"], c: 1 },
...
const SPORTS_Q = [
  ...
  { q: "What is Europe's top club football competition?", a: ["Europa League", "Champions League", "Copa America", "FA Cup"], c: 1 },
  ...
  { q: "In golf, what is one stroke under par on a hole called?", a: ["Eagle", "Birdie", "Bogey", "Par"], c: 1 },
  { q: "In golf, what is one stroke over par called?", a: ["Birdie", "Bogey", "Eagle", "Ace"], c: 1 },
  ...
  { q: "Which Grand Slam joins Wimbledon, the US Open, and the French Open?", a: ["Italian Open", "Australian Open", "Madrid Open", "Dubai Open"], c: 1 },
...
const ART_Q = [
  ...
  { q: "What is a painting depicting a person called?", a: ["Landscape", "Portrait", "Still life", "Mural"], c: 1 },
  { q: "What is a painting of fruit or objects called?", a: ["Portrait", "Still life", "Landscape", "Mural"], c: 1 },
  ...
  { q: "What type of artist was Auguste Rodin primarily?", a: ["Painter", "Sculptor", "Photographer", "Architect"], c: 1 },
  ...
  { q: "What type of Japanese artwork is The Great Wave off Kanagawa?", a: ["Sculpture", "Woodblock print", "Oil painting", "Photograph"], c: 1 },
  ...
  { q: "What is charcoal typically used for?", a: ["Painting walls", "Drawing/sketching", "Carving marble", "Printing"], c: 1 },
  ...
  { q: "What do you call a person who creates sculptures?", a: ["Painter", "Sculptor", "Novelist", "Composer"], c: 1 },
...
const SCIENCE_Q = [
  ...
  { q: "What is a group of stars forming a pattern called?", a: ["Galaxy", "Constellation", "Comet", "Nebula"], c: 1 },
...
const GEO_Q = [
  ...
  { q: "What is the imaginary line at 0° longitude called?", a: ["Equator", "Prime Meridian", "Tropic of Cancer", "Arctic Circle"], c: 1 },
    ...
    <div className="base-quiz-app" style={styles.root}>
      ...
      <footer className="base-quiz-footer" style={styles.footer}>
        ...
        <span>{totalPlayers !== null
          ? t("footer.playersOnchain", { count: totalPlayers })
          : "···"}</span>
      </footer>
